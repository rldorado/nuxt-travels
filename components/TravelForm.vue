...
const submitForm = () => {
  ...
  travel.value = {
    ...DEFAULT_EMPTY_TRAVEL,
    // INFO: We assume that new travels have a unique ID generated by the server
    id: travel.value.id !== 0 ? travel.value.id : Math.floor(Math.random() * 10000)
  };
};
